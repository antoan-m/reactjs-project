...
<div className="profile">
    ...
    <section className="profile-main">
        <section className="profile-main-left">
          ...
          <h2 className="profile-main-header">User Panel</h2>
          <ul className="profile-main-left-last-tasks-list">
                 <Link to="/user/profile/details/ID"><button className="btn waves-effect waves-light profile-list-item-btn-user">My Details<i className="material-icons right">import_contacts</i></button></Link>
