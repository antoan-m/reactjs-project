     ...
     <form id="user-AddBook">
                    ...
                    <div className="row">
                        <div className="form-field-group">
                            ...
                            <span className="vaidation-error error-text-red">Email is already AddBooked!</span>
                        </div>
                    </div>
                    <div className="row">
                        <div className="form-field-group">
                    ...
                    <div className="switch AddBook-switch">
                    <label>
                    User
                    ...
                    <div id="AddBook-buttons">
                        <button onClick={this.submitHandler.bind(this)} className="btn waves-effect waves-light AddBook-btn" name="action"><i className="material-icons left">input</i>AddBook</button>
                        <button className="btn waves-effect waves-light AddBook-btn" name="action" type="reset"><i className="material-icons left">input</i>Reset</button>
                    </div>
                </form>
                <article></article>
                </section>
                <div className="already-AddBooked">Already have an account? <Link to='./login'>LOGIN</Link></div>
    </>
  );
}
}
