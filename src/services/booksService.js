...
function getCategories() {
    return fetch(
            `http://eu-api.backendless.com/7ECE9EFE-DB9E-D320-FF17-04C136319800/D25AC5BB-3B9F-4F71-866A-6F9F6ED00656/data/books?property=category&groupBy=category&sortBy=category`, {
                headers: { "Access-Control-Allow-Origin": "*" },
            }
        )
        .then((res) => res.json())
...
function getAuthors() {
    return fetch(
            `http://eu-api.backendless.com/7ECE9EFE-DB9E-D320-FF17-04C136319800/D25AC5BB-3B9F-4F71-866A-6F9F6ED00656/data/books?property=author&groupBy=author&sortBy=author`, {
                headers: { "Access-Control-Allow-Origin": "*" },
            }
        )
        .then((res) => res.json())
...
function getFormats() {
    return fetch(
            `http://eu-api.backendless.com/7ECE9EFE-DB9E-D320-FF17-04C136319800/D25AC5BB-3B9F-4F71-866A-6F9F6ED00656/data/books?property=format&groupBy=format&sortBy=format`, {
                headers: { "Access-Control-Allow-Origin": "*" },
            }
        )
        .then((res) => res.json())
...
function getPrices() {
    return fetch(
            `http://eu-api.backendless.com/7ECE9EFE-DB9E-D320-FF17-04C136319800/D25AC5BB-3B9F-4F71-866A-6F9F6ED00656/data/books?property=price&groupBy=price&sortBy=price`, {
                headers: { "Access-Control-Allow-Origin": "*" },
            }
        )
        .then((res) => res.json())
...
function sortByNewest() {
    return fetch(
            `http://eu-api.backendless.com/7ECE9EFE-DB9E-D320-FF17-04C136319800/D25AC5BB-3B9F-4F71-866A-6F9F6ED00656/data/books?sortBy=created%20desc`, {
                headers: { "Access-Control-Allow-Origin": "*" },
            }
        )
        .then((res) => res.json())
...
function sortByOldest() {
    return fetch(
            `http://eu-api.backendless.com/7ECE9EFE-DB9E-D320-FF17-04C136319800/D25AC5BB-3B9F-4F71-866A-6F9F6ED00656/data/books?sortBy=created%20`, {
                headers: { "Access-Control-Allow-Origin": "*" },
            }
        )
        .then((res) => res.json())
...
function sortByPriceAsc() {
    return fetch(
            `http://eu-api.backendless.com/7ECE9EFE-DB9E-D320-FF17-04C136319800/D25AC5BB-3B9F-4F71-866A-6F9F6ED00656/data/books?sortBy=price%20asc`, {
                headers: { "Access-Control-Allow-Origin": "*" },
            }
        )
        .then((res) => res.json())
...
function sortByPriceDesc() {
    return fetch(
            `http://eu-api.backendless.com/7ECE9EFE-DB9E-D320-FF17-04C136319800/D25AC5BB-3B9F-4F71-866A-6F9F6ED00656/data/books?sortBy=price%20desc`, {
                headers: { "Access-Control-Allow-Origin": "*" },
            }
        )
        .then((res) => res.json())
