...
<header id="site-header">
  <section class="header-top-bar">
    ...
    <span class="header-top-bar-left-item"><a href="#">Can we help you?</a></span>
    ...
    <ul class="header-top-bar-right">
      ...
      <li class="header-top-bar-right-item"><a href="#">Store Location</a></li>
      <li class="header-top-bar-right-item">Hello, User!</li>
      <li class="header-top-bar-right-item"><a href="#">Profile</a></li>
      <li class="header-top-bar-right-item"><a href="#">Login</a></li>
      <li class="header-top-bar-right-item"><a href="#">Register</a></li>
    </ul>
  </section>

  <section class="header-top-block">
    <a href="#"><img src="./logo.jpg" alt="Book Store" /></a>
  ...
  <nav class="header-top-navigation">
    <ul class="header-top-navigation-menu">
      <li class="header-top-navigation-menu-item"><a href="#">Home</a></li>
      <li class="header-top-navigation-menu-item"><a href="#">News</a></li>
      <li class="header-top-navigation-menu-item"><a href="#">Books</a></li>
      <li class="header-top-navigation-menu-item"><a href="#">Authors</a></li>
      <li class="header-top-navigation-menu-item"><a href="#">About Us</a></li>
      <li class="header-top-navigation-menu-item"><a href="#">Authors</a></li>
    </ul>
  </nav>
...
<showcase class="home-main-sliders">
  ...
  <section class="home-main-sliders-right">
    ...
    <a href="#"><img src="slide-small-1.jpg" class="crousel-image" alt=""/></a>
    </article>
    <article class="home-main-sliders-small">
    <a href="#"><img src="slide-small-2.jpg" class="crousel-image" alt=""/></a>
    </article>
  </section>
</showcase>
...
<h2>Deals of the week</h2>
  ...
  <section class="home-weekly-deals-items">
    ...
    <a href="#"><img src="./books/book-1.jpg" class="home-weekly-deals-items-item-img" alt="Under a Firefly Moon (Firefly Lake Book 1)" /></a>
...
<h5>Address</h5>
  ...
  <p>Find us <a href="#" class="footer-address-map-link">HERE</a></p>
</article>
